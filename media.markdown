...
* Red Cap Media's pdocast and forthcoming video ([AI Hype vs Reality](https://www.youtube.com/watch?v=JaNWmH6GUS8)).
...
I serve as an Editor (Recommender) at the [Peer Community In Registered Reports](https://rr.peercommunityin.org/) and I have served as a reviewer for journals and conferences in statistics and machine learning (*ICLR*, *ICML*, *NeurIPS*, *AISTATS*), psychology (*Trends in Cognitive Science*, *Journal of Experimental Psychology*, *Cognitive Science Society*, *CCN*), philosophy of science (*BJPS*, *AI & Society*, *Synthese*), and linguistics (*Biolinguistics*, *Linguistics Vanguard*).